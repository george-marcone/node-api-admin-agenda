...
-- =========================
INSERT INTO Local
(IdLocal, IdLocalTipo, IdLocalMatriz, Descricao, Slug, CEP, Logradouro, Numero, Bairro, Cidade, UF, Situacao, Excluido)
VALUES
...
(IdProduto, DescrTituloProduto, DescrProduto, Preco, NrCargaHoraria, IdInstrumento, IdAreaConhecimento, AreaConhecimento, Certificado)
VALUES
...
(IdAtendimento, IdProduto, IdLocalAtendimento, DescrTituloProduto, DescrProduto, Preco,
NrCargaHoraria, Cidade, UF, DataInicio, DataFim, Modalidade, IdAreaConhecimento, AreaConhecimento)
VALUES
...
(1001,101,2,'Marketing Digital','Turma online',0,8,'Belo Horizonte','MG',DATE_ADD(NOW(),INTERVAL 6 DAY),DATE_ADD(NOW(),INTERVAL 6 DAY),'Remota',20,'Marketing'),
(1002,102,3,'Vendas','Turma presencial',0,8,'São Paulo','SP',DATE_ADD(NOW(),INTERVAL 7 DAY),DATE_ADD(NOW(),INTERVAL 7 DAY),'Presencial',30,'Comercial'),
